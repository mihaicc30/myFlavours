...
export default function ProfilePage({ userID }) {
  ...
  const handleDisplayNameChange = (e) => {
    ...
    displayNameTimer = setTimeout(() => {
      updateContext({ user: { displayName: displayNameValue } });
    }, 2000);
  };
  ...
  const handleUsernameChange = (e) => {
    ...
    usernameTimer = setTimeout(() => {
      updateContext({ user: { username: usernameValue } });
    }, 2000);
  };
  ...
  const handleEmailChange = (e) => {
    ...
    emailTimer = setTimeout(() => {
      updateContext({ user: { email: emailValue } });
    }, 2000);
  };
      ...
      {user && (
        <div>
          <div className="flex flex-col mx-auto max-w-[800px]">
            ...
            <div className="group cursor-not-allowed relative flex flex-col text-center mt-[5svh] mx-[10vw] border-2 border-transparent hover:border-dashed hover:border-2 hover:border-inherit ">
              <p className="absolute select-none opacity-0 group-hover:bg-gray-200/80 transition group-hover:opacity-[100%] flex justify-center items-center w-[100%] h-[100%] text-xl">Upload new avatar</p>
              {user && user?.avatar ? (
